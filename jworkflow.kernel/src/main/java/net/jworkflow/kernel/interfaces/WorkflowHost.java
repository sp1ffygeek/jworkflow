...
public interface WorkflowHost {
  String startWorkflow(String workflowId, int version, Object data, boolean runOnCallerThread) throws Exception;

  void start();

  void start(String workflowProcessorName, Integer processingThreadCount);
  ...
  void publishEvent(String eventName, String eventKey, Object eventData, Date effectiveDateUtc)
      throws Exception;
